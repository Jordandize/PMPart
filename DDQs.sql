...
INSERT INTO books VALUES
  (1, 1, 'Життєпис людини без думок', 'Історичний роман вісімнадцятого століття', 999, 399, 200000, 15.00, '2019-01-05'),
  (2, 1, 'Перший злочин', 'Незвичайна історія людини з досвідом у півстоліття', 499, 389, 180000, 16.50, '2018-08-08'),
  (3, 2, 'Справа честі', 'Історична справка роду українських гетьманів', 659, 500, 160000, 10.00, '2018-11-21'),
  (4, 3, 'Закон, написаний людьми', 'Автор ділиться з читачем думками та ідеями побудови світу, який побудували наші предки', 370, 410, 70000, 10.00, '2018-05-12'),
  (5, 5, 'Наказ', 'Роман про самосвідому особистість та частину великого бюрократичного механізму', 800, 600, 210000, 25.00, '2018-01-30');
